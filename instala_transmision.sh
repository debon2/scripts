...
jq '.["download-dir"]'='"/media/usb0/torrents"' $SETTINGS > $TEMPORAL && mv $TEMPORAL $SETTINGS
jq '.["incomplete-dir"]'='"/media/usb0/torrents/tmp"' $SETTINGS > $TEMPORAL && mv $TEMPORAL $SETTINGS
